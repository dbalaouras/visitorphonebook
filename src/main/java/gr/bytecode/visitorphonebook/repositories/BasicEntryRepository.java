...
public class BasicEntryRepository extends AbstractRepository<Entry> implements
	 ...
	 * 
	 * @see
	 * gr.bytecode.visitorphonebook.repositories.EntryRepository#findEntryByName
	 * (java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * gr.bytecode.visitorphonebook.repositories.EntryRepository#getEntries(
	 * java.lang.Long, int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see gr.bytecode.visitorphonebook.repositories.EntryRepository#
	 * getEntryByNameAndCat(java.lang.String, java.lang.Long)
	 */
	@Override
